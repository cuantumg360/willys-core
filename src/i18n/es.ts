...
export const es = {
  ...
  'home.health.title': 'Salud de {name}',
  'home.health.empty': 'Escanea a {name} para ver su puntuación de salud',
  'home.health.scan': 'Escanear ahora',
  'home.health.excellent': 'Salud excelente',
  'home.health.good': 'Buena salud',
  'home.health.fair': 'Mejorable',
  'home.health.poor': 'A vigilar',
  ...
  'result.zones.title': 'Análisis por zonas',
  'result.zones.caption': 'Dónde está en su punto y dónde acumula grasa tu perro',
  'result.zones.ideal': 'Ideal',
  'result.zones.mild': 'Leve',
  'result.zones.excess': 'Exceso',
  'result.yourPhotos': 'Tus fotos',
  ...
  'settings.notifications.enable': 'Activar avisos de cuidados',
  'settings.notifications.onTitle': 'Avisos activados',
  'settings.notifications.onBody': 'Te avisaremos de las vacunas y cuidados de tu perro a tiempo.',
  'settings.notifications.offTitle': 'Avisos no disponibles',
  'settings.notifications.offBody': 'Actívalos desde los Ajustes de tu iPhone para no perderte ningún cuidado.',
